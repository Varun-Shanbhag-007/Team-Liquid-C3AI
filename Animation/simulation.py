...
def update(frame, cs, ci, cr, t):
    global day, iteration, currently_infected, currently_recovered, currently_suseptible, contraction_probability, global_prior, global_count
